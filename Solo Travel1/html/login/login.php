...
<body>
    <div class="full-page" style="background-image: url('http://mdbootstrap.com/img/Photos/Others/images/91.jpg'); background-repeat: no-repeat; background-size: cover; background-position: absolute;">
        <div class="sub-page">
            ...
            <div class="col-1">
                <p class='defination'>“The journey of a thousand miles <br>begins with a single step.” <br><br>follow your heart & Make new routine<br> Journey. Explore. Discover. Repeat</p>
            </div>
            </div>
        </div>
    </div>
