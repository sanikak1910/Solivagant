...
<!--<section class="vh-100 bg-image"
  style="background-image: url('C:\xamppn\htdocs\login\images\travel.webp');">-->
     <div class="navigation-bar">
        <div class="logo">
            <a href='photography.html'>logo<hr></a>
        </div>
                <nav>
                    <ul id='MenuItems'>
                    <li class="nav-item active">
                     <a class="nav-link" href="#">Home <span class="sr-only"><hr></span></a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="about.php">About Us<hr></a></li>
    ...
    <div class="card shadow-2-strong card-registration"  style="border-radius: 15px; background-color: 	#ffb6c1" style="box-shadow: 0 20px 20px rgba(0,0,0,0.15)">
        ...
        <div class="form-group">
         ...
         <input type="text" class="form-control" name ="first name" id="first_name" placeholder="First name">
        </div>

       <div class="form-row">
       <div class="form-group col-md-6">
        <label for="dob">Date Of Birth</label>
        <input type="date" class="form-control" name ="party" placeid="start"  placeholder="enter dob" min="1990-01-01-" max="2024-01-01-">
       </div>
       <div class="form-group col-md-6">
      ...
      <div class="form-row">
       <div class="form-group col-md-12">
        ...
        <input type="text" class="form-control" id="inputsTate" placeholder="e.g Maharashtra">
        </div>
      </div>
      ...
      <div class="form-group">
       ...
       <input type="email" class="form-control"  name ="email"id="inputAddress2" placeholder="Enetr your email">
      </div>
      
      <div class="d-grid gap-2 col-6 mx-auto"> 
      <button type="button" class="btn btn-danger btn-rounded btn-lg" style="background-color:	#f08080"><font color="black">sign up</button>
    </div>
